...
import 'package:missing/screens/scan%20qr%20Code.dart';
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          const Padding(
            padding: EdgeInsets.only(top: 270,left: 95),
            child: Text("Discover QR Code",
            style: TextStyle(
              fontSize: 24,
          ...
          GestureDetector(
            ...
            child: const Padding(
              ...
              child: Image(image: AssetImage("assets/QR_photo.png")),
            ),
          )
        ],
      ),
